...
This `neo4j-basic` environment is designed for CI, headless setups, or scripted workflows—i.e., any non-interactive context.
...
```sh
# Clone the repo
git clone https://github.com/barstoolbluz/floxenvs && cd floxenvs/neo4j-basic
